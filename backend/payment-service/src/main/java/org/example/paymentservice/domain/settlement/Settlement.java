...
public class Settlement {
    ...
    public void hold(String reason, boolean manual) {
        transition(SettlementStatus.HELD);
        holdReason = reason;
        manualHold = manual;
    }
    ...
    public void calculate(List<SettlementLine> newLines, long adjustment) {
        ...
        payoutAmount = Math.addExact(payoutAmount, adjustment);
        calculatedAt = Instant.now();
        holdReason = null;
        transition(SettlementStatus.CALCULATED);
    }
