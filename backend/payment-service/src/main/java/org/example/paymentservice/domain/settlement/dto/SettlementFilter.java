...
public record SettlementFilter(Instant from, Instant to, SettlementStatus status, Long festivalId,
        ...
        public SettlementFilter(Instant from, Instant to, SettlementStatus status, Long festivalId, Long hostUserId, PaymentMethodCategory paymentMethod, boolean testPayment, String dateBasis) {
            this(from, to, status, festivalId, hostUserId, paymentMethod, testPayment, dateBasis, null, null);
        }
        public SettlementFilter(Instant from, Instant to, SettlementStatus status, Long festivalId,
