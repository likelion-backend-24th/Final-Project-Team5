        ...
        <form className="space-y-4 p-6" onSubmit={handleGenerate} noValidate>
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="예: 대학 축제, 인디밴드 공연과 푸드트럭 존, 이틀간 진행"
              value={prompt}
          ...
          <p className="text-xs text-gray-500">
            소개글·일정·티켓 종류(최대 3개) 초안을 만들어드려요. "2주 뒤", "다음 달 초" 같은 표현도 오늘 날짜
            기준으로 계산해요. 언급하지 않은 정보(날짜·가격 등)는 기본값으로 채워지니 생성 후 꼭 확인해주세요.
          </p>
