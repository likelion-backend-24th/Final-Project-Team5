      ...
      <div className="flex flex-col items-start gap-8 rounded-3xl bg-gradient-to-br from-brand-blue to-brand-magenta px-6 py-10 md:flex-row md:items-center md:justify-between md:px-10">
        ...
        <div className="flex w-full flex-col gap-3 sm:flex-row md:w-auto">
          {isHost ? (
            <Link
              to="/host/festivals"
              className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/30 bg-white/10 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-white/20"
            >
            ...
            <Link
              to="/organizers/apply"
              className="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-sm font-bold text-brand-blue transition hover:bg-blue-50"
            >
